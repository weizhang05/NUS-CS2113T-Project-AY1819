...
* It is a Java application targeted at *Organizing Committee Members* of *School of Computing Freshman Orientation Camps*.
* The application is a useful tool to manage the contacts of OGLs and participating freshmen. Its features include:
** An easy to use GUI with a list panel displaying contacts
** Multiple login user types with different permissions
** Listing OGLs and freshmen separately
** Viewing graphical statistics of the camp participants
