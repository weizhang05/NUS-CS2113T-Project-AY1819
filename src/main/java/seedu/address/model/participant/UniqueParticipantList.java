 ...
 * unique in terms of identity in the UniqueParticipantList. However, the removal of a person uses Person#equals(Object) so
 ...
 */
public class UniqueParticipantList implements Iterable<Person> {
