...
public class AddCommandSystemTest extends AddressBookSystemTest {
    ...
    public void add() {
         ...
         */
        Person toAdd = AMY;
        String command = "   " + AddCommand.COMMAND_WORD + "  " + NAME_DESC_AMY + "  " + SEX_DESC_AMY + " " + BIRTHDAY_DESC_AMY + " " + PHONE_DESC_AMY + " "
        ...
        command = AddCommand.COMMAND_WORD + NAME_DESC_BOB + PHONE_DESC_AMY + EMAIL_DESC_AMY + MAJOR_DESC_AMY
                + TAG_DESC_FRIEND;
        assertCommandSuccess(command, toAdd);
        ...
        toAdd = BOB;
        command = AddCommand.COMMAND_WORD + TAG_DESC_FRIEND + PHONE_DESC_BOB + MAJOR_DESC_BOB + NAME_DESC_BOB
        ...
        command = AddCommand.COMMAND_WORD + SEX_DESC_AMY + BIRTHDAY_DESC_AMY  + PHONE_DESC_AMY + EMAIL_DESC_AMY + MAJOR_DESC_AMY + GROUP_DESC_AMY;
        assertCommandFailure(command, String.format(MESSAGE_INVALID_COMMAND_FORMAT, AddCommand.MESSAGE_USAGE));

        /* Case: missing phone -> rejected */
        command = AddCommand.COMMAND_WORD + NAME_DESC_AMY + SEX_DESC_AMY + BIRTHDAY_DESC_AMY  + EMAIL_DESC_AMY + MAJOR_DESC_AMY + GROUP_DESC_AMY;
        assertCommandFailure(command, String.format(MESSAGE_INVALID_COMMAND_FORMAT, AddCommand.MESSAGE_USAGE));

        /* Case: missing email -> rejected */
        command = AddCommand.COMMAND_WORD + NAME_DESC_AMY + SEX_DESC_AMY + BIRTHDAY_DESC_AMY + PHONE_DESC_AMY + MAJOR_DESC_AMY + GROUP_DESC_AMY;
        assertCommandFailure(command, String.format(MESSAGE_INVALID_COMMAND_FORMAT, AddCommand.MESSAGE_USAGE));

        /* Case: missing address -> rejected */
        command = AddCommand.COMMAND_WORD + NAME_DESC_AMY + SEX_DESC_AMY + BIRTHDAY_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY + GROUP_DESC_AMY;
        assertCommandFailure(command, String.format(MESSAGE_INVALID_COMMAND_FORMAT, AddCommand.MESSAGE_USAGE));
        ...
        command = AddCommand.COMMAND_WORD + INVALID_NAME_DESC + SEX_DESC_AMY + BIRTHDAY_DESC_AMY  + PHONE_DESC_AMY + EMAIL_DESC_AMY + MAJOR_DESC_AMY + GROUP_DESC_AMY;
        assertCommandFailure(command, Name.MESSAGE_CONSTRAINTS);

        /* Case: invalid phone -> rejected */
        command = AddCommand.COMMAND_WORD + NAME_DESC_AMY + SEX_DESC_AMY + BIRTHDAY_DESC_AMY  + INVALID_PHONE_DESC + EMAIL_DESC_AMY + MAJOR_DESC_AMY + GROUP_DESC_AMY;
        assertCommandFailure(command, Phone.MESSAGE_CONSTRAINTS);

        /* Case: invalid email -> rejected */
        command = AddCommand.COMMAND_WORD + NAME_DESC_AMY + SEX_DESC_AMY + BIRTHDAY_DESC_AMY + PHONE_DESC_AMY + INVALID_EMAIL_DESC + MAJOR_DESC_AMY;
        assertCommandFailure(command, Email.MESSAGE_CONSTRAINTS);

        /* Case: invalid address -> rejected */
        command = AddCommand.COMMAND_WORD + NAME_DESC_AMY + SEX_DESC_AMY + BIRTHDAY_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY + INVALID_MAJOR_DESC;
        assertCommandFailure(command, Major.MESSAGE_CONSTRAINTS);

        /* Case: invalid tag -> rejected */
        command = AddCommand.COMMAND_WORD + NAME_DESC_AMY + SEX_DESC_AMY + BIRTHDAY_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY + MAJOR_DESC_AMY
                + INVALID_TAG_DESC;
