...
public class DeleteCommandSystemTest extends AddressBookSystemTest {
    ...
    public void delete() {
        ...
        /* Case: delete the last participant in the list -> deleted */
        Model modelBeforeDeletingLast = getModel();
        Index lastPersonIndex = getLastIndex(modelBeforeDeletingLast);
        assertCommandSuccess(lastPersonIndex);

        /* Case: undo deleting the last participant in the list -> last participant restored */
        command = UndoCommand.COMMAND_WORD;
        expectedResultMessage = UndoCommand.MESSAGE_SUCCESS;
        assertCommandSuccess(command, modelBeforeDeletingLast, expectedResultMessage);

        /* Case: redo deleting the last participant in the list -> last participant deleted again */
        command = RedoCommand.COMMAND_WORD;
        removePerson(modelBeforeDeletingLast, lastPersonIndex);
        expectedResultMessage = RedoCommand.MESSAGE_SUCCESS;
        assertCommandSuccess(command, modelBeforeDeletingLast, expectedResultMessage);

        /* Case: delete the middle participant in the list -> deleted */
        ...
        deletedParticipant = removePerson(expectedModel, selectedIndex);
        ...
        Index outOfBoundsIndex = Index.fromOneBased(
                getModel().getAddressBook().getParticipantList().size() + 1);
    ...
    /**
     * Removes the {@code Participant} at the specified {@code index} in {@code model}'s address book.
     * @return the removed participant
     */
    private Participant removePerson(Model model, Index index) {
        Participant targetParticipant = getPerson(model, index);
        model.deleteParticipant(targetParticipant);
    ...
    private void assertCommandSuccess(Index toDelete) {
        Model expectedModel = getModel();
        Participant deletedParticipant = removePerson(expectedModel, toDelete);
        String expectedResultMessage = String.format(MESSAGE_DELETE_PERSON_SUCCESS, deletedParticipant);
