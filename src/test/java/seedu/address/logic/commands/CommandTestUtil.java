...
public class CommandTestUtil {
    ...
    public static final String VALID_GROUP_AMY = "2";
    public static final String VALID_GROUP_BOB = "2";
    ...
    public static final String INVALID_GROUP_DESC = " " + PREFIX_GROUP + "#2"; // '#' not allowed in tags
