...
[WARNING]
`newGroupName` must not exist in the current list of houses
...
* `edit_g red1 green1` +
Edits the group named `RED1` to `GREEN1`.
...
Views the list of all groups added so far, including the house they have been added to. +
Format: `view_g`
