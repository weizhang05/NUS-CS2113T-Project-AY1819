...
This commmand edits the name of a group from `OLDGROUPNAME` to `NEWGROUPNAME`.
...
This command Views the list of all groups added so far, along with the house they belong to.
...
include::https://github.com/cs2113-ay1819s2-t08-4/main/blob/master/docs/UserGuide.adoc
