...
|===
|_I added the sections on Participant Management, the Export Feature and the Import Feature to the FOP Manager Developer Guide. The following section is an example contribution of the Participant Management section I wrote on in the Developer Guide. You can view the details on the Export Feature and the Import Feature in detail from the Developer Guide._
|===
